...
function AddFeatureDialog({ isOpen, setModalOpen }: Props) {
  return (
    <div
      id="default-modal"
      ...
      className={`${
        isOpen === true ? "" : "hidden"
      } overflow-x-hidden overflow-y-auto fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-50 justify-center items-center`}
    >
